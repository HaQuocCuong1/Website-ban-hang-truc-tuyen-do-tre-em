                        ...
                        <div class="auth-form">
                            <div class="auth-form__container">
                                <div class="auth-form__header">
                                    <h3 class="auth-form__heading">THÊM LOẠI SẢN PHẨM</h3>
                                </div>
                                <c:url var="saveUrl" value="/admin/loaisanpham/saveCategories" />
                                <form:form modelAttribute="categories" method="POST" action="${saveUrl}">
                                    <form:hidden path="id" />
                                    <div class="auth-form__form">
                                        <form:label path="categoryName" class="auth-form--title">Tên loại sản phẩm:</form:label>
                                        <div class="auth-form__group">
                                            <form:input path="categoryName" class="auth-form__input" placeholder="Nhập tên loại sản phẩm"/></td>
                                        </div>
                                    </div>
