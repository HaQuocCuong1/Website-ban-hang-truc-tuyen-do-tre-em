<%-- 
    Document   : orderadmin-list
    Created on : May 22, 2021, 7:42:05 PM
    Author     : ASUS
--%>
            ...
            <section class="content">
                <div class="content-product">
                    <div class="header-product">
                        <span class="header-title">Danh sách hóa đơn</span>
                    </div>
                        ...
                        <table class="table-info-product" border="1" cellpadding ="0" cellspacing ="0">
                            <thead>
                                <tr class="info-product-title--list">
                                    ...
                                    <th class="info-product-title--item">Ngày đặt hàng</th>
                                    <th class="info-product-title--item">Ngày giao hàng</th>
                            ...
                            <tbody>
                                <c:forEach items="${orders}" var="order">
                                  <%--  <c:url var="editUrl" value="/admin/loaisanpham/showFormForUpdate">
                                    ...
                                    <c:url var="viewUrl" value="/admin/chitiethoadon/list">
                                        <c:param name="orderId" value="${order.orderID}"/>
                                    </c:url>
                                    <tr class="info-product-content--list">
                                        <td class="info-product-content--item"><c:out value="${order.orderID}"/></td>
                                        <td class="info-product-content--item"><c:out value="${order.orderDate}"/></td>
                                        <td class="info-product-content--item"><c:out value="${order.shippedDate}"/></td>
                                        <td>
